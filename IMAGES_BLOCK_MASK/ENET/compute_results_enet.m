...
% Get data
for kloo = 1:ns
%    fload = sprintf('RESULTS_TRAIN/ENET_loo_%d_p_%g.mat', kloo, p);
   fload = sprintf('RESULTS_TRAIN/ENET_loo_%d_.mat', kloo);
...
fsave = 'RESULTS_TRAIN/ENET_results';
