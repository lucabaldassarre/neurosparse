function [] = compute_results_lasso

% Number of subjects
ns  = 16;
% Gray matter mask probability threshold
p   = 0.5;

% Get data
for kloo = 1:ns
   fload = sprintf('RESULTS_TRAIN/LASSO_loo_%d_p_%g.mat', kloo, p);
   ...
   alpha_tot_accuracy(kloo,:)   = alpha_t; %#ok<*AGROW>
...
% Compute overlaps
[mean_O_accuracy,   std_O_accuracy,     mean_OC_accuracy,   std_OC_accuracy,    mean_OE_accuracy,   std_OE_accuracy]    =...
    compute_overlaps(support_accuracy,n); %#ok<*ASGLU>
[mean_O_dist_OC,    std_O_dist_OC,      mean_OC_dist_OC,    std_OC_dist_OC,     mean_OE_dist_OC,    std_OE_dist_OC]     =...
    compute_overlaps(support_dist_OC,n);
[mean_O_dist_corr,  std_O_dist_corr,    mean_OC_dist_corr,  std_OC_dist_corr,   mean_OE_dist_corr,  std_OE_dist_corr]   =...
    compute_overlaps(support_dist_corr,n);

% Compute correlations
corr_accuracy = corrcoef(alpha_tot_accuracy');
dummy = corr_accuracy;
dummy(1:ns+1:end)   = []; % Remove self-correlations
...
fsave = 'RESULTS_TRAIN/LASSO_results';
disp([1-mean_err_loo_accuracy std_err_loo_accuracy; mean_corr_accuracy std_corr_accuracy; mean_sparsity_accuracy std_sparsity_accuracy; mean_O_accuracy std_O_accuracy; mean_OC_accuracy std_OC_accuracy; 0 RST_accuracy/100]*100);
disp([1-mean_err_loo_dist_OC std_err_loo_dist_OC; mean_corr_dist_OC std_corr_dist_OC; mean_sparsity_dist_OC std_sparsity_dist_OC; mean_O_dist_OC std_O_dist_OC; mean_OC_dist_OC std_OC_dist_OC; 0 RST_dist_OC/100]*100);
disp([1-mean_err_loo_dist_corr std_err_loo_dist_corr; mean_corr_dist_corr std_corr_dist_corr; mean_sparsity_dist_corr std_sparsity_dist_corr; mean_O_dist_corr std_O_dist_corr; mean_OC_dist_corr std_OC_dist_corr; 0 RST_dist_corr/100]*100);
save(fsave);