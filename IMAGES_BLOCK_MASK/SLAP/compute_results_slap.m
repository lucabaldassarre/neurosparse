...
% Get data
for kloo = 1:ns
%    fload = sprintf('RESULTS_TRAIN/SLAP_loo_%d_p_%g.mat', kloo, p);
   fload = sprintf('RESULTS_TRAIN/SLAP_loo_%d_%g.mat', kloo, p);
   load(fload,'err_val_accuracy','alpha_accuracy','err_val_dist_OC','alpha_dist_OC','err_val_dist_corr','alpha_dist_corr');
   ...
   err_loo_accuracy(kloo) = err_val_accuracy;
   ...
   err_loo_dist_OC(kloo) = err_val_dist_OC;
   ...
   err_loo_dist_corr(kloo) = err_val_dist_corr;
...
clear kloo fload alpha_t err_val_dist_OC err_val_dist_corr err_val_accuracy alpha_accuracy alpha_dist_OC alpha_dist_corr
fsave = 'RESULTS_TRAIN/SLAP_results';
