...
% Save file
fsave = sprintf('RESULTS_VAL/STV_loo_%d_val_%d_regpartv_%d_fista_tol_%g_p_%g.mat',ksv,ks,regpartv_ind, pars.tol,p);
...
for kregpar1 = 1:nregpar1
   ...
   fprintf('\nSubject test loo = %d of %d, Subject val loo = %d of %d, Reg par TV = %d of %d, Reg par l1 = %d of %d\n',ks,ns,ksv,nsv,regpartv_ind, nregpartv, kregpar1,nregpar1);
...
clear Xtr ytr Xts yts Xva yva B kregpar1
disp(datestr(now));
disp('FINISHED!');
time_end = cputime;
