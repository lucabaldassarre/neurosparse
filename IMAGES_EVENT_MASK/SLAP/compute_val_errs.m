...
for ks = 1:ns % External LOO
   ...
   for ksv = 1:nsv % Internal LOO
      for klambda_2 = 1:nlambda_2
         fload = sprintf('RESULTS_VAL/SLAP_loo_%d_val_%d_gamma_%d_tol_%g_p_%g.mat', ks, ksv, klambda_2, tol_fista, p);
   ...
   fsave = sprintf('RESULTS_VAL/SLAP_loo_errs_%d_%g.mat', ks, p);
   fprintf('SAVING LOO: %d of %d \n', ks, ns);
