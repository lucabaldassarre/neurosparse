% Find best regularization parameters for STV
...
for ks = 1:ns % External LOO
   ...
   for ksv = 1:nsv % Internal LOO
      for klambda_2 = 1:nlambda_2
         fload = sprintf('RESULTS_VAL/STV_loo_%d_val_%d_regpartv_%d_fista_tol_%g_p_%g.mat', ks, ksv, klambda_2, tol,p);
   ...
   fsave = sprintf('RESULTS_VAL/STV_loo_errs_%d_%g.mat',ks, p);
